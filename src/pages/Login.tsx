    ...
    <div className="auth-page">
      ...
      <main className="auth__form-side">
        ...
        <div className="auth__skyline" aria-hidden="true">
          ...
          >
            {/*
              Original monochrome travel skyline — TripZ Auth
              Landmarks (L→R): small buildings, dome, tower, arch, pagoda,
              minaret, clock tower, pyramid, obelisk, colosseum arch, skyscrapers
            */}
            <path
