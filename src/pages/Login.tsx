      ...
      <main className="login__main">
        <div className="login__card" role="main">
          <div className="login__card-header">
            ...
            <p className="login__sub">Log in to continue your journey.</p>
          </div>
          ...
          <form className="login__form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="login__row">
              ...
              <button type="button" className="login__forgot btn btn-ghost">
                Forgot password?
              </button>
            </div>
            ...
            <button type="button" className="login__google-btn" aria-label="Continue with Google">
          ...
          <p className="login__create">
            ...
            <Link to="/login" className="login__create-link">Create account</Link>
          </p>
        </div>
      </main>
    </div>
